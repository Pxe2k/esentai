            ...
            <div>
                    ...
                    <div class="news-column1">
                        <div class="column1-text">
                            <div class="column1-title">
                                <h4 class="text text-while text-s34">The Ritz-Carlton Opens <br/>
                                    in Almaty
                                    By HolpitaliyNet</h4>
                            </div>
                ...
                <div class="news-column">
                    <div class="news-column1">
                        <div class="column1-text">
                            <div class="column1-title">
                                <h4 class="text text-while text-s34">Esentai Tower <br/>& Mall </h4>
                            </div>
                            <div class="avtor text text-while text-s15">Авто статьи: Карлс Виктор</div>
                            <div class="paragraf-news text text-while text-s15">
                ...
                <div class="news-column">
                    <div class="news-column1">
                        <div class="column1-text">
                            <div class="column1-title">
                                <h4 class="text text-while text-s34">Level 8 innovational project <br/>By The Village  </h4>
                            </div>
                            <div class="avtor text text-while text-s15">Авто статьи: Карлс Виктор</div>
                            <div class="paragraf-news text text-while text-s15">
