...
<div class="wrap">
    <div class="soc">
            ...
            <a href="https://www.linkedin.com/company/capital-tower-development/about" target="_blank">
                ...
                <a class="mail" href="mailto:hr@esentaitower.com">info@esentaitower.com</a>
        ...
        <div class="container">
            <div>
                <div class="about-title title-bottom text text-s34" data-aos="fade-right">
                    <a href="/infrastructure">О НАС</a>
                </div>
                <div class="about-top">
                                        <div class="about-top__column" data-aos="zoom-in">
                        <img src="/storage/abouts/March2022/p3O4jFCcNUoRH4o7k6Tn.png">
                        <h4 class="text text-s15">Capital Tower Development </h4>
                        <p class="text text-s15">
                            Лидер на рынке Республики Казахстан в сфере управления коммерческой недвижимости класса А с опытом работы на рынке более 15 лет. 
                        </p>
                    </div>
                                        <div class="about-top__column" data-aos="zoom-in">
                        <img src="/storage/abouts/March2022/hWu6Si8WE13pDTEiJXoT.png">
                        <h4 class="text text-s15">Миссия</h4>
                        <p class="text text-s15">
                            Высокие стандарты управления недвижимостью для реализации ваших амбиций.
                        </p>
                    </div>
                                        <div class="about-top__column" data-aos="zoom-in">
                        <img src="/storage/abouts/February2022/grAdqgtTmViROSvzLMS5.png">
                        <h4 class="text text-s15">   </h4>
                        <p class="text text-s15">
                                
                        </p>
                    </div>
                                        <div class="about-top__column" data-aos="zoom-in">
                        <img src="/storage/abouts/February2022/EbJFe1YVTV5ZZ088wIgO.png">
                        <h4 class="text text-s15">   </h4>
                        <p class="text text-s15">
            ...
            <div class="about-bottom">
                    ...
                    <div class="about-btm__title">
                        <img src="/storage/advantages/March2022/OtOKE4AewkTjVOA2qxI6.png">
                    ...
                    <p class="text text-s15">
                        27 000 квадратных метров офисных помещений международного класса А.
                    </p>
                </div>
                                <div class="about-bottom__column" data-aos="fade-right">
                    <div class="about-btm__title">
                        <img src="/storage/advantages/December2021/UEl8jfr68TfkzoZL0o3I.png">
                        <h5 class="text text-s34">
                            <a style="color: black" href="/infrastructure">
                                LEED Certificate
                            </a>
                    ...
                    <p class="text text-s15">
                        В 2018 году Esentai Tower получил серебряный сертификат зеленого здания Leadership in Energy and Environmental Design (LEED).
                    </p>
                </div>
                            </div>
    ...
    <div class="infrast">
        <div class="container">
            ...
            <div class="slider" data-aos="fade-left">
                ...
                <a class="infrast-btn infrast-btn-1 active" href="https://esentai.com/">
                    <img src="img/arrau.png" alt="">
                </a>
                <a class="infrast-btn infrast-btn-3" href="https://esentai-tower.a-lux.dev/infrastructure">
                    <img src="img/arrau.png" alt="">
                </a>
                <a class="infrast-btn infrast-btn-4" href="https://www.ritzcarlton.com">
                    <img src="img/arrau.png" alt="">
                </a>
                <a class="infrast-btn infrast-btn-5" href="https://esentaiapartments.com">
                    <img src="img/arrau.png" alt="">
                </a>
            </div>
        </div>
            ...
            <div class="projects-1">
                <div class="projects-1__column">
                    <div class="project-1-title title-bottom" data-aos="fade-right">
                        <a href="/project/1">
                            <h3 class="text text-s34">ПРОЕКТЫ</h3>
                        </a>
                    </div>
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="swiper-text">
                                    ...
                                    <p>Level 8 это приватные офисы и коворкинг пространство, где резиденты могут сосредоточиться на своей работе и платить гибкую аренду. Офисы полностью оборудованы, так что клиентам не придется беспокоиться об их администрировании.</p>
<p>&nbsp;</p>
<p>Общая площадь Level 8 составляет 1 600 квадратных метров, к услугам клиентов круглосуточный доступ в офисное пространство, система безопасности в зданий, меблированные и оборудованных приватные кабинеты, релакс зона с капсулой Energy Pod, пять малых и один большой конференц-зал, кабинеты для конфиденциальных телефонных переговоров, оборудованная кухня, зона печати, отдел канцелярских принадлежностей, гардероб, камеры хранения и большая коворкинг-зона с кафетерием.</p>
                                    <br><a href="/project/1">ЧИТАТЬ ДАЛЕЕ ></a>
                                </div>
                                <div class="slider_project_1">
                                    <img class="slider-1-img" src="/storage/projects/December2021/n5QZAcxPXd46UkMtESij.jpg">
                                </div>
                            </div>
                                                        
                                                        <div class="project-1-p swiper-slide" data-aos="fade-right">
                                <div class="swiper-text">
                                    <h4 class="text text-s25">LEVEL 2</h4>
                                    <p>Level 8 - это приватные офисы и коворкинг пространство, где резиденты могут сосредоточиться на своей работе и платить гибкую аренду. Офисы полностью оборудованы, так что клиентам не придется беспокоиться об их администрировании.</p>
                                    <br><a href="/project/4">ЧИТАТЬ ДАЛЕЕ ></a>
                                </div>
                                <div class="slider_project_1">
                                    <img class="slider-1-img" src="/storage/projects/January2022/tlqAnVAtL27lc0dCxgUY.jpg">
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="swiper" id="news">
                <div class="swiper-wrapper swiper-wrapper-bottom">
                        ...
                        <div class="slider-content__title"><p>Открытие отеля The Ritz-Carlton в Алматы</p></div>
                        <div class="slider-content__data">
                            <p>Hospitality Net</p>
                        </div>
                        <div class="slider-content__paragraf">
                            <p>
                                Вневременная роскошь пришла в город Алматы, распахнув двери отеля The Ritz-Carlton в нашей стране. Самый долгожданный отель в Центральной Азии представили The Ritz-Carlton Hotel Company, L.L.C. и международный застройщик Capital Partners.

                            </p>
                            <br>
                            <a href="/news/1" style="color:white">ЧИТАТЬ ДАЛЕЕ</a>
                        </div>
                    </div>
                                        <div class="project-1-p swiper-slide swiper-slide-second" style="flex-direction: column;padding: 0 5rem;" data-aos="fade-right">
                        <div class="slider-content__title"><p>Почему модный туризм переживает</p>
<p>подъем в Центральной Азии</p></div>
                        <div class="slider-content__data">
                            <p>Стефан Рабимов</p>
                        </div>
                        <div class="slider-content__paragraf">
                            <p>
                                В прошлом году более 1,2 миллиарда путешественников превратили международный модный туризм в одну из самых быстрорастущих отраслей. Растущий спрос со стороны туристов с Китая и Индий на предметы роскоши и путешествия по всему миру помогает пополнить казну соседних государств. Страна Центральной Азий, которая произвела фурор и как место проведения Всемирной выставки ЭКСПО-2017, и как новый рынок предметов роскоши, теперь поставил перед собой амбициозную цель увеличения доли туризма в ВВП до восьми процентов в течение десятилетия.
                            </p>
                            <br>
                            <a href="/news/2" style="color:white">ЧИТАТЬ ДАЛЕЕ</a>
                        </div>
                    </div>
                                        <div class="project-1-p swiper-slide swiper-slide-second" style="flex-direction: column;padding: 0 5rem;" data-aos="fade-right">
                        <div class="slider-content__title"><p>Как выглядит офис&nbsp; Level 8?</p></div>
                        <div class="slider-content__data">
                            <p>The Village</p>
                        </div>
                        <div class="slider-content__paragraf">
                            <p>
                                Capital Partners — девелоперская компания, основанная в 2001 году. За 17 лет работы Capital Partners реализовала крупные проекты в Москве, Стамбуле и Бодруме. Основные проекты Capital Partners в Казахстане — Esentai Park, отель The Ritz-Carlton, Almaty, Esentai Mall, «Алматинский Финансовый Центр» и горнолыжный курорт «Шымбулак».
                            </p>
                            <br>
                            <a href="/news/3" style="color:white">ЧИТАТЬ ДАЛЕЕ</a>
                        </div>
                    </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div id="partners">
            	<div class="swiper-wrapper partner-img">
                	     ...
                	     <img src="/storage/partners/May2022/1C0mgBxl3lufHLrCJyCE.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/MyfpRhpEIr7myoNxbzf3.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/DoNYeKxuKIIbwR0BgQRL.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/C4JVKg871h5nhtWEdJFp.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/SfJYAVWLYRIDHjCvqP0J.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/pi8IgLQcWiH3dHvsCiaB.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/7FHPbcQtc8zNlA3JYjAm.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/1yWOSD3XD8Zmp8x0Bccg.svg">
                        </div>
                    		    	<div class="swiper-slide partner-slide">
                	     <img src="/storage/partners/May2022/zfatNqcOZ9aRXOenDFAj.svg">
                        </div>
                                    </div>
                <div class="swiper-button-prev button-prev"></div>
                <div class="swiper-button-next button-next"></div>
