...
<div class="projects1">
    <div class="news1">
        <div class="container">
            <h2  data-aos="fade-down">The Ritz-Carlton Opens in Almaty
                By HolpitaliyNet</h2>
            <p class="awtor" data-aos="fade-down">Авто статьи: Карлс Виктор</p>
            <img class="news1back" src="./img/news/news1/news1back.png" data-aos="zoom-in">
            <p class="news1-text2" data-aos="fade-left">Timeless luxury came to Almaty, Kazakhstan when The RitzCarlton opened its first
            ...
            <p class="news1-text2" data-aos="fade-right">The new luxury hotel with 145 rooms offers unmatched elegance and is the latest
            ...
            <p data-aos="fade-left">“We're excited to bring The RitzCarlton brand to Kazakhstan. Almaty is an important city for our
            ...
            <p class="news1-text2" data-aos="fade-right">RitzCarlton again to bring their prestigious hotel brand to Almaty.</p>

            <p class="news1-text2" data-aos="fade-left">“Capital Partners invests and develops projects all over the world, but our roots are
            ...
            <p class="news1-text2" data-aos="fade-right"> Mr. Oymen added," We are also pleased to announce The Ritz Carlton Residences on the
            ...
            <p class="news1-text2" data-aos="fade-left">Almaty, formerly a major city in Kazakhstan, is the largest city in the republic and
            ...
            <p class="news1-text2" data-aos="fade-right">Almaty, which literally means "City of Apple Trees", also offers extraordinary
